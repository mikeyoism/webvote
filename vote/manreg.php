<?php
/**
 public page för snabbinmatning av pappersröster
 * ------------------------------------------------------------------------
 *
...
<head>
    ...
    <!--combine if mass access-->
    <script src="js/vote_common.min.js" type="text/javascript"></script>
    <script src="js/vote_manreg.min.js" type="text/javascript"></script>
...
<div class="ui-header ui-bar-a" data-swatch="a" data-theme="a" data-form="ui-bar-a" data-role="header" role="banner">
    <h1 class="ui-title" id ="competition_header" tabindex="0" role="heading" aria-level="1" data-mini="true">Röstregistrering SM 2014 </h1> <!--js dynamic-->       
</div>
